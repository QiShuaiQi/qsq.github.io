...
([
    ...
    function(module, exports, __webpack_require__) {
        ...
        var render = function render(res) {
            ...
            for (var j = 0, len2 = res.list.length; j < len2; j++) {
                ...
                for (var i = 0, len = data.link.length; i < len; i++) {
                    ...
                    var minSrc = 'https://gitee.com/study66/blog-img/raw/master/img-master/min_photos/' + data.link[i];
                    var src = 'https://gitee.com/study66/blog-img/raw/master/img-master/photos/' + data.link[i];
        ...
        var replacer = function replacer(str) {
            var arr = str.split("/");
            return "/photos/ins/" + arr[arr.length - 1];
        };
